<template>
  <div>
    <h2 class="text-center my-4">Политика конфиденциальности</h2>
    <p class="text-justify">
      ...
      которую ООО «Сенатор», может получить о Пользователе во время
      использования сайта: senator-wine.ru (далее – Сайт).
    </p>
    ...
    <p class="text-justify">
      ...
      сайтом, действующие от имени ООО «Сенатор», которые организуют и (или)
      ...
      персональных данных (Пользователя) или наличия иного законного
      основания.<br />
      1.1.5. «Пользователь Сайта (далее - Пользователь)» – лицо, имеющее доступ
      к Сайту, посредством сети Интернет и использующее Сайт.<br />
      1.1.6. «Cookies» — небольшой фрагмент данных, отправленный веб-сервером и
      хранимый на компьютере или мобильном устройстве пользователя, который
      ...
      1.1.7. «IP-адрес» — уникальный сетевой адрес узла в компьютерной (или
      мобильной) сети, построенной по протоколу IP.
    </p>
    ...
    <p class="text-justify">
      ...
      senator-wine.ru. Администрация сайта не контролирует и не несет
      ответственность за сайты третьих лиц, на которые Пользователь может
      перейти по ссылкам, доступным на Сайте и иных сайтах.<br />
    ...
    <p class="text-justify">
      ...
      по запросу Администрации сайта при регистрации на Сайте, активации
      дисконтных карт, при резервировании товара или при обратной связи с
      ...
      3.2.4. дата рождения;<br />
      3.2.5. пол;<br />
      3.2.6. место жительство Пользователя.<br />
      3.3.2. Администрация сайта осуществляет сбор статистики об IP-адресах
      своих посетителей. Данная информация используется с целью выявления и
      решения технических проблем. 3.4. Пользовательские данные (сведения о
      ...
      открывает и на какие кнопки нажимает пользователь; ip-адрес) подлежат
      надежному хранению и нераспространению, за исключением случаев,
      предусмотренных в п. 5.2. настоящей Политики конфиденциальности.
    </p>
    ...
    <p class="text-justify">
      ...
      активации дисконтных<br />
      карт, для резервирования товара и обратной связи. 4.1.2. Предоставления
      Пользователю доступа к персонализированным ресурсам Сайта.<br />
      ...
      обработки заявок на резервирование товара от Пользователя.<br />
      ...
      4.1.6. Создания учетной записи, если Пользователь дал согласие на создание
      учетной записи.<br />
      4.1.7. Уведомления Пользователя Сайта о состоянии резерва.<br />
      ...
      4.1.9. Предоставления Пользователю с его согласия, обновлений продукции,
      специальных предложений, информации о ценах, новостной рассылки и иных
      сведений от имени Администрации сайта или от имени ее партнеров.<br />
    ...
    <p class="text-justify">
      5.1. Обработка персональных данных Пользователя осуществляется до момента
      прекращения деятельности ООО «Килобайт», либо до момента отзыва согласия
      на обработку персональных данных Пользователем, либо его законным
      представителем, любым законным способом, в том числе в информационных
      ...
      в порядке, установленным законодательством Российской Федерации.<br />
      5.3. Администрация сайта вправе поручить обработку персональных данных
      ...
      (далее – поручение оператора). Лицо, осуществляющее обработку персональных
      данных по поручению Администрации сайта, обязано соблюдать принципы и
      правила обработки персональных данных, предусмотренные Федеральным законом
      от 27.07.2006 №152-ФЗ «О персональных данных».<br />
    ...
    <p class="text-justify">
      ...
      необходимую для пользования Сайтом.<br />
    ...
    <p class="text-justify">
      ...
      исключением случаев, предусмотренных п.п. 5.2. и 5.3. настоящей Политики
      ...
      6.2.5. Лица, получившие доступ к персональным данным в порядке,
      предусмотренном п. 5.3. настоящей Политики Конфиденциальности, обязаны не
      раскрывать третьим лицам и не распространять персональные данные без
      согласия Пользователя, если иное не предусмотрено федеральным законом.
    </p>
    ...
    <p class="text-justify">
      ...
      предусмотренных п. 5.2. и 7.2. настоящей Политики Конфиденциальности.<br />
      ...
      7.3. В случае, если Администрация сайта поручает обработку персональных
      данных другому лицу, ответственность перед Пользователем за действия
      указанного лица несёт Администрация сайта. Лицо, осуществляющее обработку
      персональных данных по поручению Администрации сайта, несёт
      ответственность перед Администрацией сайта.
    </p>
    ...
    <p class="text-justify">
      ...
      следует сообщать в раздел на сайте Обратная связь.<br />
      9.4. Действующая Политика конфиденциальности размещена на странице по
      адресу: www.senator-wine.ru.
    </p>
  </div>
</template>
